#!/usr/bin/env python3
"""
Implementing a get_hyper method that takes the same arguments
...
class Server:
    """
    The Server class to paginate a database named "popular baby names2.csv".
    """
    ...
    def assert_positive_integer_type(value: int) -> None:
        """
        Asserts that the value is a +ve int.
        Args:
